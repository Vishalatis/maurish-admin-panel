var islinechart = document.getElementById("lineChart"),
    lineChart = (islinechart.setAttribute("width", islinechart.parentElement.offsetWidth), new Chart(islinechart, {
        type: "line",
        data: {
    ...
    barChart = (isbarchart.setAttribute("width", isbarchart.parentElement.offsetWidth), new Chart(isbarchart, {
        type: "bar",
        data: {
