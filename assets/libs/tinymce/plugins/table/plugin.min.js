...
! function() {
    ...
    function X(e, n, t) {
        if (t || 2 === arguments.length)
            for (var r, o = 0, u = n.length; o < u; o++) !r && o in n || ((r = r || Array.prototype.slice.call(n, 0, o))[o] = n[o]);
    ...
    function vt(e) {
        ...
        var u = F(o).map(function(e) {
                var o, u, n = (o = {}, u = 0, A(e.cells, function(t) {
                    var r = t.colspan;
                    D(r, function(e) {
                        var n = u + e;
                        o[n] = {
    ...
    function zo(e, n) {
        ...
        var u, r, i, c, l, a, f, s, o, m, d, g, p = fr(e),
            b = ct(p),
            h = Vl(e),
            v = $t.generate(b),
        ...
        return A(Vt(p, "th,td", function(e) {
            ...
            function(e, n, t, r) {
                for (var o, u, i, c = n.grid.columns, l = n.grid.rows, a = 0; a < l; a++)
                    for (var f = !1, s = 0; s < c; s++) a < t.minRow || a > t.maxRow || s < t.minCol || s > t.maxCol || ($t.getAt(n, a, s).filter(r).isNone() ? (o = f, 0, u = e[a].element, i = Ve.fromTag("td"), Xt(i, Ve.fromTag("br")), (o ? Xt : Ot)(u, i)) : f = !0)
    ...
    function Uo(e, n, t) {
        var r, o, u = (It(o = sr(r = e, n), ln(fr(r))), o);
    ...
    function $o(a, f, s) {
        ...
        return {
            ...
            row: qo(f),
            cell: function(e) {
                var n, t, r, o, u, i = Ve.fromTag(Ye(e.element), f.dom),
        ...
        a.on("BeforeGetContent", function(t) {
            ...
            !0 === l.selection && !0 === l.paste && j(Ql(e)).each(function(c) {
                rt(c).each(function(e) {
                    var n, t, r, o, u = k((n = l.content, (t = document.createElement("div")).innerHTML = n, ln(Ve.fromDom(t))), function(e) {
                            return "meta" !== Ye(e)
                        }),
                        i = en("table");
    ...
    function au(e, n, t, r, o) {
        var u, i, c, l, a, f, s, m, d, g, p = $t.fromTable(e),
            b = o.getCellDelta(n),
            h = o.getWidths(p, o),
    ...
    function Au(e, n, t) {
        return o = n, u = !1, i = sa, c = t, l = function(e) {
            i(e) && c(Ou(e))
    ...
    function _u(e, n, t, r, o) {
        ...
        i = n, c = g, l = f, a = wr(t), Lu(i, c, function(e, n) {
            var t, r, o, u, i, c = (t = n.row, r = l.left - e.left, o = n.y - e.top, u = a, qn(i = Ve.fromTag("div"), {
                position: "absolute",
                left: r + "px",
                top: o - 3.5 + "px",
                height: "7px",
        ...
        var p, b, h, v, w, y, C, S = 0 < o.length ? ao.positions(o, t) : [],
        ...
        v = n, w = x, y = f, C = xr(t), Lu(v, w, function(e, n) {
            var t, r, o, u, i, c = (t = n.col, r = n.x - e.left, o = y.top - e.top, u = C, qn(i = Ve.fromTag("div"), {
                position: "absolute",
                left: r - 3.5 + "px",
                top: o + "px",
                height: u + "px",
    ...
    function bi(p) {
        ...
        return p.on("init", function() {
            var e, n, t, r, o, u, i, c, l, a, m, f, s, d, g = (n = pi, (e = p).inline ? (u = Yo(e), qn(c = Ve.fromTag("div"), {
                position: "static",
                height: "0",
                width: "0",
                padding: "0",
    ...
    function Bi(m, d) {
        ...
        return O(m, function(e, s) {
            var n = N(e.cells, function(e, n) {
                if (!1 !== g[s][n]) return [];
                var t, r, o, u, i, c, l, a, f = (o = n, u = d, l = (t = m)[r = s], a = "colgroup" === l.section, {
    ...
    function qi(e, t, i, c) {
        ...
        return 0 < t && t < l.length && (n = l[t - 1].cells, r = i, A(B(n, function(e, n) {
            ...
            for (var o = q.none(), u = t; u < l.length; u++)
                for (var n = 0; n < dt(l[0]); n++) ! function(n) {
                    var t = l[u],
                        r = st(t, n);
        ...
        return function(e, n, t) {
            ...
            return function(e, n, t, r, o, u) {
                for (var i, c, l, a, f, s = e.row, m = e.column, d = s + t.length, g = m + dt(t[0]) + u.length, p = L(u, x), b = s; b < d; b++)
                    for (var h, v, w, y = 0, C = m; C < g; C++) p[C] ? y++ : (l = C, a = void 0, a = P(o, st((i = n)[c = b], l).element), f = i[c], 1 < i.length && 1 < dt(f) && (0 < l && a(mt(f, l - 1)) || l < f.cells.length - 1 && a(mt(f, l + 1)) || 0 < c && a(mt(i[c - 1], l)) || c < i.length - 1 && a(mt(i[c + 1], l))) && Vi(n, mt(n[b], C), o, r.cell), v = (h = st(t[b - s], C - m - y)).element, w = r.replace(v), ft(n[b], C, we(w, !0, h.isLocked)));
                return n
            }(a, t, f, i, c, o)
        })
    }
    ...
    function tc(e, u, i, c, l) {
        return O(e, function(e) {
            var n, t, r = 0 < u && u < dt(e) && c(mt(e, u - 1), mt(e, u)),
    ...
    function yc(e, n, t) {
        var r, o, u, i, c, l = (r = n, o = t, c = gt(e).rows, q.from(null === (i = null === (u = c[r]) || void 0 === u ? void 0 : u.cells[o]) || void 0 === i ? void 0 : i.element).filter(hc).orThunk(function() {
    ...
    function Tc(e, n, t) {
        var r, o = (r = t.section, ut(e, function() {
            return r
        }));
        ...
        function t(c, l, a, f, s) {
            return function(t, e, o) {
                ...
                return l(t) ? c(n, t, e, u, i).bind(function(e) {
                    ...
                    var r, n = (r = t, e.cursor.fold(function() {
    ...
    function zc(u, i, c, l, a) {
        ...
        return u.undoManager.ignore(function() {
            ...
            var n, t, r, o = (n = e, t = Ve.fromTag("div"), r = Ve.fromDom(n.dom.cloneNode(!0)), Xt(t, r), t.dom.innerHTML);
    ...
    function dl(e, n) {
        ...
        0 !== i.length && (l = e, t = al(rt((r = i)[0]).map(function(e) {
            return O(sl(e, r), function(e) {
                return t = l, r = e.element, o = Zu(l), u = e.column, i = t.dom, c = u.getOr(r), K({
                    width: n(c, "width"),
                    height: n(r, "height"),
    ...
    function pl(s, m, d, e) {
        ...
        e.close(), s.undoManager.transact(function() {
            ...
            0 < ge(f) && (n = Ke(f, "type"), (t = !n || 1 < ge(f)) && (i = r, c = e, l = u, a = 1 === o.length, A(o, function(e) {
                var n, t, r, o = a ? Nf.normal(i, e) : Nf.ifTruthy(i, e),
                    u = c;
    ...
    function bl(i) {
        var e, t, n, r, o, u, c, l = (e = tu(i), t = Xl.selected, r = (n = Jl(e)).bind(function(e) {
            return rt(e)
        ...
        0 !== l.length && (o = al(O(l, function(e) {
            return n = i, t = e.dom, r = ei(i), u = n.dom, K({
        ...
        e.close(), "" === l.class && delete l.class, u.undoManager.transact(function() {
            ...
            i || (e = parseInt(l.cols, 10) || 1, n = parseInt(l.rows, 10) || 1, i = zc(u, e, n, 0, 0)), 0 < ge(a) && (function(e, n, t) {
                var r, o = e.dom,
                    u = {},
                    i = {};
                if (u.class = t.class, i.height = eu(t.height), o.getAttrib(n, "width") && !ti(e) ? u.width = (r = t.width) ? r.replace(/px$/, "") : "" : i.width = eu(t.width), ti(e) ? (i["border-width"] = eu(t.border), i["border-spacing"] = eu(t.cellspacing)) : (u.border = t.border, u.cellpadding = t.cellpadding, u.cellspacing = t.cellspacing), ti(e) && n.children)
                    for (var c = 0; c < n.children.length; c++) Wf(o, n.children[c], {
                        "border-width": eu(t.border),
                        padding: eu(t.cellpadding)
                    }), ni(e) && Wf(o, n.children[c], {
                        "border-color": t.bordercolor
                    });
                ni(e) && (i["background-color"] = t.backgroundcolor, i["border-color"] = t.bordercolor, i["border-style"] = t.borderstyle), u.style = o.serializeStyle(K(K({}, Qu(e)), i)), o.setAttribs(n, K(K({}, Ju(e)), u))
    ...
    function vl(e, n) {
        var t, r, o, u, i, c, l, a, f, s, m, d, g, p, b, h, v, w, y, C = e.dom,
        ...
        !1 === n ? (t = C.getParent(e.selection.getStart(), "table", e.getBody())) ? (d = t, g = ni(m = e), v = m.dom, w = ti(m) ? v.getStyle(d, "border-spacing") || v.getAttrib(d, "cellspacing") : v.getAttrib(d, "cellspacing") || v.getStyle(d, "border-spacing"), y = ti(m) ? Fc(v, d, "padding") || v.getAttrib(d, "cellpadding") : v.getAttrib(d, "cellpadding") || Fc(v, d, "padding"), S = K({
    ...
    function yl(l, n, e, a, t) {
        ...
        function c(c, e) {
            return e().each(function(e) {
                var i = O(e, fr);
                f(function(e, n) {
                    var t, r, o = Ko(Ve.fromDom(l.getDoc())),
                        u = (t = i, r = o, {
                            selection: ru(a),
                            clipboard: t,
                            generators: r
    ...
    function Nl(o, u) {
        function r(e) {
            ...
            var n, t, r = (n = u(e), $a(n.element) ? o.col(n) : o.cell(n));
            return i = q.some({
                item: e,
                replacement: r
            }), r
    ...
    var _l = /(\d+(\.\d+)?)%/,
        ...
        vf = zi(function(e, n, t, r) {
            var o, u, i = (o = n.clipboard, u = n.generators, Mi($t.fromTable(o), u, !0));
            return Qi({
                row: n.row,
                column: n.column
    ...
    function ps(e) {
        ...
        var n, t, r, o, u, i, c, l, a, f, s, m = Ve.fromDom(e.anchorNode),
    ...
    function Bm(I, B, e) {
        ...
        return I.on("init", function(e) {
            var n, t, r, o, u, i, m, d, g, a, c, l, f, s, p, b, h = I.getWin(),
                v = Yo(I),
                w = Zo(I),
                y = (n = Us(h), {
            ...
            var O, A, k = (O = Xc(Ve.fromDom(v)), A = Xc(0), {
                touchEnd: function(e) {
    ...
    Yr.add("table", function(c) {
        ...
        return yl(c, h, 0, d, v), f = h, s = d, m = Zo(a = c), ae({
            ...
            function(n, e, t, r) {
                ...
                var n, t, r, o, u = c,
                    i = b;
                (n = e).keyCode === Qs.TAB && (t = Yo(u), r = function(e) {
                    var n = Ye(e);
