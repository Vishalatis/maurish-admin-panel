...
! function() {
    ...
    var o, r = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        u = function(n) {
    ...
    function w(n, t) {
        var e, o = null === (e = n.dom.getAttribute(t)) ? void 0 : e;
    ...
    function S(f, n) {
        m(K(M.fromDom(n), O), function(n) {
            var t, e, o, r, i, u = n.dom.parentNode;
    ...
    function B(e, o) {
        return function(t) {
            ...
            return t.setActive(o.get()), e.on("VisualChars", n),
                function() {
    ...
    r.add("visualchars", function(n) {
        var t, e, o, r, i, u, c, a, s, f, l = (t = n.getParam("visualchars_default_state", !1), e = t, {
            get: function() {
                return e
            },
            set: function(n) {
