...
! function() {
    ...
    var t, n = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        u = function(e) {
            return typeof e === t
        };
    ...
    function T(M, t) {
        ...
        function u(e) {
            ...
            var T = function(e) {
                ...
                c = function(e, t, n) {
                    var r, a, o, c, l, i, u, s, m, f, p, d, g, y = (r = M, -1 === (a = n).indexOf("<html>") && (o = "", c = r.getParam("content_style", "", "string"), l = r.getParam("content_css_cors", !1, "boolean") ? ' crossorigin="anonymous"' : "", O.each(r.contentCSS, function(e) {
    ...
    n.add("template", function(e) {
        ...
        }(y, a)), a.addCommand("mceTemplate", (l = o = a, c = function(e) {
            T(l, e)
        }, function() {
