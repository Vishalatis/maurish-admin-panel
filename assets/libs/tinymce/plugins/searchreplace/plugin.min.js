...
! function() {
    ...
    function $(u, e) {
        ...
        return U(u, e.commonAncestorContainer, r, i, {
            ...
            cef: function(e) {
                var t, n, r, o, i, a = w((n = fe.fromDom(e), r = "*[contenteditable=true]", 1 !== (o = i = void 0 === n ? document : n.dom).nodeType && 9 !== o.nodeType && 11 !== o.nodeType || 0 === o.childElementCount ? [] : y(i.querySelectorAll(r), fe.fromDom)), function(e) {
                        var t = e.dom;
                        return U(u, t, t)
                    }),
                    c = function(e, t) {
    ...
    function ie(i, a) {
        var e, t, n, r = (e = p, t = g(T.none()), v(v({}, n = {
            clear: function() {
                o(), t.set(T.none())
            },
            isSet: function() {
            ...
            h = {
                ...
                onAction: function(e, t) {
                    ...
                    switch (t.name) {
                        ...
                        case "wholewords":
                        case "inselection":
                            n = e.getData(), r = a.get(), a.set(v(v({}, r), {
