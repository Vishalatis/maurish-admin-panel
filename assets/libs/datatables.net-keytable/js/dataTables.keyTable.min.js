...
! function(n) {
    ...
    function s(e, t) {
        ...
        if (this.c = c.extend(!0, {}, o.defaults.keyTable, s.defaults, t), this.s = {
                dt: new o.Api(e),
                enable: !0,
                focusDraw: !1,
                waitingForDraw: !1,
    ...
    return c.extend(s.prototype, {
            ...
            if (i = i || null, this.s.enable) {
                ...
                if (-1 !== l.length && (e < l.start || e >= l.start + l.length)) this.s.focusDraw = !0, this.s.waitingForDraw = !0, o.one("draw", function() {
                    ...
                    r = o.cells(null, t, {
                        search: "applied",
                        order: "applied"
                    }).flatten(), l = o.cell(r[e]), r = this._emitEvent("key-prefocus", [this.s.dt, l, i || null]);
                    if (-1 === r.indexOf(!1)) {
                        if (a) {
        ...
        _scroll: function(e, t, n, i) {
            var s = n[i](),
                ...
                c = e.height(),
                e = e.width();
            "position" === i && (s.top += parseInt(n.closest("table").css("top"), 10)), s.top < a && s.top + o > a - 5 && t.scrollTop(s.top), s.left < r && t.scrollLeft(s.left), s.top + o > a + c && s.top < a + c + 5 && o < c && t.scrollTop(s.top + o - c), s.left + l > r + e && l < e && t.scrollLeft(s.left + l - e)
        },
        ...
        _tabInput: function() {
            var n = this,
                i = this.s.dt,
                e = null !== this.c.tabIndex ? this.c.tabIndex : i.settings()[0].iTabIndex; - 1 != e && (this.s.tabInput || ((e = c('<div><input type="text" tabindex="' + e + '"/></div>').css({
                position: "absolute",
                height: 1,
                width: 0,
                overflow: "hidden"
        ...
        keys: null,
        tabIndex: null
    }, s.version = "2.9.0", c.fn.dataTable.KeyTable = s, c.fn.DataTable.KeyTable = s, o.Api.register("cell.blur()", function() {
